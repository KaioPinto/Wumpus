...
public class Map {
    ...
    private void generateMapOfTreasure() {
        ...
        while (mapOfTreasureCount < 1) {
            ...
            if (scenario[mapRandomX][mapRandomY] == null) {
                ...
                this.mapLocation = new Point(mapRandomX, mapRandomY); //
                mapOfTreasureCount++;
    ...
    public void moveRobot(Point nextPoint) {
        String cell = this.scenario[nextPoint.getPositionX()][nextPoint.getPositionY()];
    ...
    public boolean isValidMove(Point point) {
        ...
        int[] scenarioSize = getScenarioSize();
        if (point.getPositionX() < 0 || point.getPositionX() >= scenarioSize[0] ||
                point.getPositionY() < 0 || point.getPositionY() >= scenarioSize[1]) {
            return false;
        }


        String cell = get(point);
        if (cell != null && cell.equals(Rock.CHARACTER)) {
            return false;
        }
